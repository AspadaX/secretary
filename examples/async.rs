...
async fn main() -> anyhow::Result<()> {
    ...
    task.push(secretary::message_list::Role::User, "Please extract product information from the following text")?;
    task.push(secretary::message_list::Role::Assistant, "I'll help you extract the product information accurately.")?;
...
mod tests {
    ...
    fn test_context_management() {
        ...
        task.push(secretary::message_list::Role::User, "Test message").unwrap();
