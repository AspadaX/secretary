...
pub fn smart_parse_value(content: &str, field_name: &str) -> Value {
...
pub fn parse_numeric_value(content: &str) -> Option<f64> {
...
pub fn set_nested_field(json_map: &mut Map<String, Value>, field_path: &str, value: Value) {
